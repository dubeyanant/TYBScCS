...
{
    char pname[20];
    int at, bt, ct, bt1, p; // no p in sjf
...
void accept_info()
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        printf("Enter priority:"); // this is extra
        scanf("%d", &p->p); // this is extra
...
void print_output()
{
    ...
    while (p != NULL)
    {
        ...
        printf("%s\t%d\t%d\t%d\t%d\t%d\t%d\n", p->pname, p->at, p->bt, p->p, p->ct, tat, wt); // diff
